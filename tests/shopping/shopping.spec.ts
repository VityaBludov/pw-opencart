...
test('pick product from catalog and proceed to payment @regression', async ({ homePage, searchResultsPage, productPage, checkoutPage, purchaseFlow }) => {
    ...
    await purchaseFlow.buyProduct(searchResultsPage, productPage, checkoutPage)
})
